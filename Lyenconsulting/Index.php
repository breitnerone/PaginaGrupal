...
<?php
  if (isset($_SESSION["nombreCompleto"])) 
  {
    echo "<a href='cerrarsesion.php' title='Cerrar sesión'>Bienvenid@</a>" . 
        $_SESSION["usuario"] . " (" . $_SESSION["nombreCompleto"] . ")";
  }
  else	  
  {
	echo "<form class='login-form' action='login.php' target='_blank'><input type='submit' class='more_btn' value='Registro'></form>";
  }
?>
    ...
    var myLatlng = new google.maps.LatLng(4.6515843,-74.1133241);
    ...
    var contentString = '<img src="http://eslibertadcr.org/wp-content/uploads/2015/10/empresa.jpg" width="200" style="display:block;margin:auto;"><p>Lyen Consulting</p>';
